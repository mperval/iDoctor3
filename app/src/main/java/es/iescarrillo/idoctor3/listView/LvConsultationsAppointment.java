...
public class LvConsultationsAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lv_consultations_appointment);
        ...
        lvConsultation.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(LvConsultationsAppointment.this, GenerateAppointmentActivity.class);
    ...
    private void getComponentFromView(){
        ...
        btnBackLVCons = findViewById(R.id.btnBackLVConsApp);
        lvConsultation = findViewById(R.id.lvConsultationApp);
    }
}